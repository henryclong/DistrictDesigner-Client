...
class Map extends Component {
  ...
  render() {
      return (
        <div>
            <div id='map'></div>
            <DisplayModal zoomed={this.state.zoomed} terminalUpdates={this.state.terminalUpdates}/>
            <ToolModal zoomed={this.state.zoomed} stateZoom={this.stateZoom} resetZoom={this.resetZoom} selectedState={this.state.selectedState} onStart={this.onStart} onPause={this.onPause} onStop={this.onStop} updateSettings={this.updateSettings}/>
        </div>
      );
  }
